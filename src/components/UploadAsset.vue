...
<template>
  <div class="p-5 border rounded-lg bg-gray-50 max-w-lg mx-auto mt-5">
    <h2 class="text-center text-xl font-bold text-gray-800 mb-5">Upload New Asset</h2>
    <form @submit.prevent="uploadAsset">
      <div class="mb-4">
        <label for="file" class="block font-bold mb-2">Asset File:</label>
        <input type="file" id="file" @change="handleFileChange" required class="w-full px-2 py-1 border rounded" />
      </div>
      <div class="mb-4">
